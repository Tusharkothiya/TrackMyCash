...
export const transactionServices = {
  ...
  createTransaction: async (request: Request, payload: TransactionPayload): Promise<ServiceResult> => {
    ...
    try {
      ...
      if (operation?.flag) {
        // Email feature removed - transaction created successfully
      }
  ...
  updateTransaction: async (
    ...
    try {
      ...
      if (operation?.flag) {
        ...
        if (userDoc?.email) {
          // Email feature removed - transaction updated successfully
        }
      }
  ...
  deleteTransaction: async (request: Request, transactionId: string): Promise<ServiceResult> => {
    ...
    try {
      ...
      if (operation?.flag) {
        ...
        if (transactionId) {
          // Email feature removed - transaction deleted successfully
        }
      }
